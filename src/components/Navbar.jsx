...
const Navbar = ({ darkMode, toggleDarkMode }) => {
    ...
    return (
        <div className="flex justify-between w-full fixed z-50 mt-4 ">
            <motion.nav 
                initial={{ y: -100 }}
                animate={{ y: 0 }}
            ...
            w-[90%] lg:w-auto lg:min-w-[600px] mx-auto`}
            >
                <div className="flex items-center justify-between w-full space-x-6 lg:space-x-8">
                                ...
                                {activeSection === item.name.toLowerCase() && (
                                    <motion.div 
                                        ...
                                        className={`absolute -bottom-1 left-0 right-0 
                                            w-full h-0.5 bg-linear-to-r rounded-full ${colors.indicator}`}
                                    />
                                )}
                            </a>
                        ))}
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <motion.button
                            ...
                            className={`p-2 rounded-full  
                               ${darkMode ? "bg-gray-700" : "bg-gray-200 "} transition-colors duration-300`}
                        ...
                        <motion.a 
                            ...
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className={`hidden  lg:block items-center px-6 py-2 rounded-full text-sm font-semibold bg-linear-to-r ${colors.button} text-white shadow-md hover:shadow-lg transition-shadow`}>
                                Hire Me
                    ...
                    <div className="flex lg:hidden items-center space-x-4 px-2">
                       ...
                       className={`p-2 rounded-lg ${darkMode ? "bg-gray-700" : "bg-gray-200 "} transition-colors duration-300`}>
                   {isMenuOpen ? (
                ...
                {isMenuOpen && (
                    <motion.div
                        ...
                        <div className="px-4 py-3 space-y-2">
                            ...
                            className={`block py-3 p-4 text-center font-semibold 
